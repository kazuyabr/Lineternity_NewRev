...
import ext.mods.commons.gui.damage;

public class DamageBalanceFrame extends JFrame {

	private static final long serialVersionUID = 1L;

	public DamageBalanceFrame() {
		...
		JLabel label = new JLabel("Search class: ");
