...
import ext.mods.extensions.listener.manager.ZoneListenerManager;
...
public abstract class ZoneType
{
	...
	public void revalidateInZone(Creature creature)
	{
		...
		if (isInsideZone(creature))
		{
			if (_creatures.add(creature))
			{
				...
				onEnter(creature);
				ZoneListenerManager.getInstance().notifyZoneEnter(this, creature);
			}
		}
		else
	...
	public void removeCreature(Creature creature)
	{
		if (_creatures.remove(creature))
		{
			...
			onExit(creature);
			ZoneListenerManager.getInstance().notifyZoneLeave(this, creature);
		}
	}
