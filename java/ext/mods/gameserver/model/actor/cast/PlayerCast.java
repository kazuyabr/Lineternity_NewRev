...
import ext.mods.gameserver.handler.skillhandlers.StriderSiegeAssault;
import ext.mods.gameserver.handler.skillhandlers.SummonFriend;
import ext.mods.gameserver.handler.skillhandlers.TakeCastle;
...
public class PlayerCast extends PlayableCast<Player>
{
	...
	public void doInstantCast(L2Skill skill, ItemInstance item)
	{
		...
		final boolean chargeHandledBySkillHandler = (skillId == 345 || skillId == 346);
		if (skill.getNumCharges() > 0 && !chargeHandledBySkillHandler)
		{
