...
public class FuncDirectBonus extends Func
{
	public FuncDirectBonus(Player owner, Stats stat, int value, Object ownerMarker)
	{
		super(ownerMarker, stat, 30, value, null);
	}
