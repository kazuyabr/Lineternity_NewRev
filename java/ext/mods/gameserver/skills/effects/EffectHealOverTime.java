...
import ext.mods.gameserver.network.serverpackets.ExRegenMax;
...
public class EffectHealOverTime extends AbstractEffect
{
	...
	public boolean onActionTime()
	{
		...
		final double adjusted = BossZergManager.getInstance().applyHealPenalty(getEffector(), getEffected(), getTemplate().getValue());
		getEffected().getStatus().addHp(adjusted);
		return true;
	}
}