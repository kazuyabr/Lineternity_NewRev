 ...
 * Data: 29/01/2026
 * Versão: 1.0.0
 * Descrição: Gerencia o comando de raid e aplica teleporte aos jogadores.
 * 
*/
public class Raid implements IVoicedCommandHandler
{
	...
	private void showRaidHtm(Player player, int page)
	{
		...
		for (NpcTemplate npc : list)
		{
			...
			final String teleLink = Config.RAID_BOSS_TELEPORT_ENABLED
				? "<a action=\"bypass voiced_raid tele " + npc.getNpcId() + " " + page + "\">Tele</a>"
				: "";
	...
	{
		if (!Config.RAID_BOSS_TELEPORT_ENABLED)
			return;
