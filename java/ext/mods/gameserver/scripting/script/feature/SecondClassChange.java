...
public class SecondClassChange extends Quest
{
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		switch (npc.getNpcId())
		{
			case 31328, 30195, 30699, 30474, 31324, 30862, 30910, 31285, 31331, 31334, 31974, 32096:
			...
			case 30513, 30681, 30704, 30865, 30913, 31288, 31326, 31977:
			...
			case 30511, 30676, 30685, 30845, 30894, 31269, 31314, 31958:
			...
			case 30512, 30677, 30687, 30847, 30897, 31272, 31317, 31961:
				if (player.getRace() == ClassRace.DWARF)
				{
					if (player.getClassId().getLevel() == 1)
					{
			...
			case 30109, 30187, 30689, 30849, 30900, 31965, 32094:
			...
			case 30115, 30174, 30176, 30694, 30854, 31996:
			...
			case 30120, 30191, 30857, 30905, 31276, 31321, 31279, 31755, 31968, 32095, 31336:
				if (player.getRace() == ClassRace.HUMAN || player.getRace() == ClassRace.ELF)
				{
					if (player.getClassId().getLevel() == 1)
					{
