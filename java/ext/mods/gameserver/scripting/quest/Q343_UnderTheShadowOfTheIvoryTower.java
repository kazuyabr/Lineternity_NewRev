...
public class Q343_UnderTheShadowOfTheIvoryTower extends Quest
{
	...
	public Q343_UnderTheShadowOfTheIvoryTower()
	{
		...
		DROPS.put(20563, new IntIntHolder(630000, 12));
		DROPS.put(20564, new IntIntHolder(630000, 12));
		DROPS.put(20565, new IntIntHolder(650000, 12));
		DROPS.put(20566, new IntIntHolder(680000, 13));
