...
/**
 * Listener para garantir que Agathions sigam o player quando ele teleporta
 */
public class AgathionTeleportListener implements OnTeleportListener
{
	@Override
	public void onTeleport(Player player, int x, int y, int z)
	{
		Agathion agathion = player.getCurrentAgation();
		if (agathion != null)
		{
			agathion.forceFollowPlayer();
		}
	}
}
