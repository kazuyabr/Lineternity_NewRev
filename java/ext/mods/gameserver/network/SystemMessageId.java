...
public final class SystemMessageId
{
	...
	/**
	 * ID: 1186<br>
	 * Message: To create a new account, please visit the PlayNC website (http:
	 */
	public static final SystemMessageId TO_CREATE_ACCOUNT_VISIT_WEBSITE;
	
	/**
	 * ID: 1187<br>
	 * Message: If you forgotten your account information or password, please visit the Support Center on the PlayNC website(http:
	 */
	...
	/**
	 * ID: 1312<br>
	 * Message: The latest version of MSN Messenger may be obtained from the MSN web site (http:
	 */
	...
	/**
	 * ID: 1809<br>
	 * please visit the PlayNC website (http:
	 */
	...
	/**
	 * ID: 1920<br>
	 * Message: Your account is currently inactive because you have not logged into the game for some time. You may reactivate your account by visiting the PlayNC website (http:
	 */
