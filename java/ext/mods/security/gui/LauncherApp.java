...
public class LauncherApp {
    ...
    private static String _loggedUserEmail;
    ...
    public static String getLoggedUserEmail() { return _loggedUserEmail; }
    public static void setLoggedUserEmail(String loggedUserEmail) { _loggedUserEmail = loggedUserEmail; }
    public static String getKey() { return _key; }
    public static void setKey(String val) { _key = val; }
}