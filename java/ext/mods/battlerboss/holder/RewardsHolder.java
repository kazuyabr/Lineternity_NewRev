...
public class RewardsHolder
{
	private final List<RewardHolder> winners;
	private final List<RewardHolder> losers;
	
	public RewardsHolder(List<RewardHolder> winners, List<RewardHolder> losers)
	{
		this.winners = winners;
		this.losers = losers;
	}
	
	public List<RewardHolder> getWinners()
	{
		return winners;
	}
	
	public List<RewardHolder> getLosers()
	{
		return losers;
	}
}
